<template>
  <div class="formulir container">
    ...
    <b-card header-tag="nav">
      ...
      <template #default >
        <validation-observer ref="formulir" v-slot="{ handleSubmit, invalid }">
          <b-form @submit.prevent.stop="handleSubmit(simpan)">
            <!-- STEP 1 -->
            <div v-if="stepTab === 1" class="mb-5 h-75" style="overflow-y: auto; overflow-x:hidden">
              <validation-provider
                name="Nama Lengkap"
                rules="required"
                v-slot="{ valid, errors }"
            ...
            <div class="mb-5" v-if="stepTab === 2">
              ...
              <validation-provider name="Tempat Lahir Ayah" rules="">
                ...
                >
                  <b-form-input
                    v-model.trim="form.tempat_lahir_ayah"
                    class="col-12 col-sm-8 col-md-6"
              ...
              <validation-provider name="Tanggal Lahir Ayah">
                ...
                >
                  <b-form-datepicker
                    ...
                    class="col-12 col-md-6"
                    locale="id-ID"
                    :min="new Date(1935, 0, 1)"
                    :max="new Date((new Date().getFullYear() - 27), new Date().getMonth(), new Date().getDate())"
                  ></b-form-datepicker>
                </b-form-group>
              </validation-provider>
              <validation-provider
              ...
              >
                ...
                >
                  <b-form-input
                    v-model.trim="form.nomor_hp_ayah"
              ...
              <validation-provider name="Tempat Lahir Ibu" rules="">
                ...
                >
                  <b-form-input
                    v-model.trim="form.tempat_lahir_ibu"
                    class="col-12 col-sm-8 col-md-6"
              ...
              >
                ...
                >
                  <b-form-input
                    v-model.trim="form.nomor_hp_ibu"
              ...
              <validation-provider name="Tempat Lahir Wali" rules="">
                ...
                >
                  <b-form-input
                    v-model.trim="form.tempat_lahir_wali"
                    class="col-12 col-sm-8 col-md-6"
              ...
              <validation-provider name="Tanggal Lahir Wali">
                ...
                >
                  <b-form-datepicker
                    ...
                    locale="id-ID"
                    :min="new Date(1935, 0, 1)"
                    :max="new Date((new Date().getFullYear() - 20), new Date().getMonth(), new Date().getDate())"
                  ></b-form-datepicker>
                </b-form-group>
              </validation-provider>
              <validation-provider
              ...
              >
                ...
                >
                  <b-form-input
                    v-model.trim="form.nomor_hp_wali"
              ...
              >
                ...
                >
                  <b-form-input
                    v-model.trim="form.nomor_kk_wali"
                    placeholder="16 Digit No Nomor KK Wali"
                    class="col-12 col-sm-8 col-md-6"
                    :state="errors[0] ? false : valid ? true : null"
                  ></b-form-input>
                </b-form-group>
                <b-button variant="success" type="submit" size="lg" :disabled="invalid">Simpan</b-button>
              </validation-provider>
            </div>
          </b-form>
        </validation-observer>
...
import {  putPrivateData } from '../../helper/api';
  ...
  methods: {
    getPendaftar() {
      ...
      if (!Object.entries(person).length) {
        this.$store
          ...
          .then((res) => {
            if (res.id_desa) {
              this.selectedProvinsi = parseInt(res.id_desa.toString().substr(0, 2));
              this.selectedKabupaten = parseInt(res.id_desa.toString().substr(0, 4));
              this.selectedKecamatan = parseInt(res.id_desa.toString().substr(0, 6));
            }
          });
      } else {
        if (person.id_desa) {
          this.selectedProvinsi = parseInt(person.id_desa.toString().substr(0, 2));
          this.selectedKabupaten = parseInt(person.id_desa.toString().substr(0, 4));
          this.selectedKecamatan = parseInt(person.id_desa.toString().substr(0, 6));
        }
      }
    },
    async simpan() {
      ...
      try {
        ...
        const update = await putPrivateData(`/person/${this.$route.params.id}`, updateData)
    ...
    setDataWali(val) {
      ...
      if (val === "3") {
        ...
        this.form.tempat_lahir_wali = this.form.tempat_lahir_ibu;
        this.form.tanggal_lahir_wali = this.form.tanggal_lahir_ibu;
        this.form.id_pekerjaan_wali = this.form.id_pekerjaan_ibu;
        this.form.id_jenjang_pendidikan_wali = this.form.id_jenjang_pendidikan_ibu;
        this.form.id_penghasilan_wali = this.form.id_penghasilan_ibu;
        this.form.nomor_hp_wali = this.form.nomor_hp_ibu;
      } else {
        this.form.jk_wali = "L";
        this.form.nama_wali = this.form.nama_ayah;
        this.form.nik_wali = this.form.nik_ayah;
        this.form.tempat_lahir_wali = this.form.tempat_lahir_ayah;
        this.form.tanggal_lahir_wali = this.form.tanggal_lahir_ayah;
        this.form.id_pekerjaan_wali = this.form.id_pekerjaan_ayah;
        this.form.id_jenjang_pendidikan_wali = this.form.id_jenjang_pendidikan_ayah;
        this.form.id_penghasilan_wali = this.form.id_penghasilan_ayah;
        this.form.nomor_hp_wali = this.form.nomor_hp_ayah;
      }
    },
  },
  mounted() {

...
const dataKeluarga = [
    ...
    {field: 'id_pekerjaan_ayah', desc: 'Pekerjaan Ayah', required: true},
    {field: 'id_jenjang_pendidikan_ayah', desc: 'Pendidikan Terakhir Ayah', required: true},
    {field: 'id_penghasilan_ayah', desc: 'Rerata Penghasilan Ayah', required: true},
    ...
    {field: 'id_pekerjaan_ibu', desc: 'Pekerjaan Ibu', required: true},
    {field: 'id_jenjang_pendidikan_ibu', desc: 'Pendidikan Terakhir Ibu', required: true},
    {field: 'id_penghasilan_ibu', desc: 'Rerata Penghasilan Ibu', required: true},
    ...
    {field: 'id_pekerjaan_wali', desc: 'Pekerjaan Wali', required: true},
    {field: 'id_jenjang_pendidikan_wali', desc: 'Pendidikan Terakhir Wali', required: true},
    {field: 'id_penghasilan_wali', desc: 'Rerata Penghasilan Wali', required: true},
